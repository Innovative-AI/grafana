...
func TestAlertInstanceOperations(t *testing.T) {
	...
	alertDefinition1 := util.CreateTestAlertDefinition(t, dbstore, 60)
	orgID := alertDefinition1.OrgID

	alertDefinition2 := util.CreateTestAlertDefinition(t, dbstore, 60)
	require.Equal(t, orgID, alertDefinition2.OrgID)

	alertDefinition3 := util.CreateTestAlertDefinition(t, dbstore, 60)
	require.Equal(t, orgID, alertDefinition3.OrgID)

	alertDefinition4 := util.CreateTestAlertDefinition(t, dbstore, 60)
